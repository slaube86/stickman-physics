...
const FACTS = {
  ...
  ninjago_ice: {
    icon: "❄️",
    title: "Gefrorener Tempelteich",
    text: "Auf Eis ist die Reibung sehr gering – genau wie auf dem gefrorenen Tempelteich! Zane, der Eis-Ninja, nutzt das zu seinem Vorteil. Wenig Reibung = weites Rutschen!",
  },
  ninjago_training: {
    icon: "🥋",
    title: "Ninja-Training & Trägheit",
    text: "Ninjas trainieren täglich, um Kraft und Balance zu verbessern. In der Physik nennt man das Trägheit – ein Körper behält seine Bewegung bei, bis eine Kraft ihn bremst!",
  },
  ninjago_spin: {
    icon: "🌀",
